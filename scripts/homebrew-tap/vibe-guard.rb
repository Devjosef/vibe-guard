...
class VibeGuard < Formula
  ...
  desc "🛡️ Vibe-Guard Security Scanner - 25 essential security rules to catch vulnerabilities before they catch you!"
  homepage "https://github.com/Devjosef/vibe-guard"
  url "https://github.com/Devjosef/vibe-guard/archive/refs/tags/v1.1.4.tar.gz"
  ...
  test do
    ...
    assert_match "1.1.4", shell_output("#{bin}/vibe-guard --version", 0)
